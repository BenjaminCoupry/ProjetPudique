...
def shr(n, x):
    '''
    Décalage de x à droite de n bits.
    '''
    return x >> n
...
def rotr_32(n, x):
    '''
    Rotation de x à droite de n bits, x sur 32 bits.
    '''
    return (x >> n) | ( (x << (32-n)) & U32_MAX )


def big_sigma_0_256(x):
    '''
    Zouaverie n°3.
    '''
...
def small_sigma_0_256(x):
    '''
    Zouaverie n°5.
    '''
    return rotr_32(7, x) ^ rotr_32(18, x) ^ shr(3, x)


def small_sigma_1_256(x):
    '''
    Zouaverie n°6.
    '''
    return rotr_32(17, x) ^ rotr_32(19, x) ^ shr(10, x)
